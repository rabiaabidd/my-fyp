...
import Records from '../../json/105SurahFil/SurahFilTranslation.json';
...
const SurahFilTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة الفيل</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Fil" className="tab-link" activeClassName="active-tab">
Word By Translation Word & Grammar
  </NavLink>
  <NavLink to="/SurahFil105Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahFilTranslation;
