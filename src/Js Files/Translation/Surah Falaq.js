...
import Records from '../../json/113SurahFalak/SurahFalakTranslation.json';
...
const SurahFalakTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
      <div>
      <div className="tab">
      <NavLink to="/Surah Falaq" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahFalak113Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahFalakTranslation;
