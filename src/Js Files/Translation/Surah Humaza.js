...
import Records from '../../json/104SurahHumaza/SurahHumazaTranslation.json';
...
const SurahHumazaTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
      <div>
      <div className="tab">
      <NavLink to="/Surah Humaza" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahHumaza104Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahHumazaTranslation;
