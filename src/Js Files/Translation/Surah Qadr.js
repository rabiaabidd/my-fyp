...
import Records from '../../json/97SurahQadr/SurahQadrTranslation.json';
...
const SurahQadrTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة القدر</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Qadr" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahQadr97Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahQadrTranslation;
