...
import Records from '../../json/103SurahAsr/SurahAsrTranslation.json';
...
const SurahAsrTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة العصر</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Asr" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahAsr103Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahAsrTranslation;
