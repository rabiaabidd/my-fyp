...
import Records from '../../json/112SurahIkhlas/SurahIkhlasTranslation.json';
...
const SurahIkhlasTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   return (
    ...
    <div>
    <div className="tab">
    <NavLink to="/Surah Ikhlas" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
</NavLink>
<NavLink to="/SurahIkhlas112Resources" className="tab-link" activeClassName="active-tab">
More Resources
</NavLink>
...
export default SurahIkhlasTranslation;
