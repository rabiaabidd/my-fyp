...
import Records from '../../json/98SurahBayyinah/SurahBayyinahTranslation.json';
...
const SurahBayyinahTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة البينة</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Bayyinah" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahBayyinah98Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahBayyinahTranslation;
