...
import Records from '../../json/80SurahAbasa/SurahAbasaTranslation.json';
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
      ...
      <div>
      <div className="tab">
      <NavLink to="/Surah Abasa" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahAbasa80Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahAbasaTranslation;
