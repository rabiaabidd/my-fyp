...
import Records from '../../json/99SurahZalzalah/SurahZalzalahTranslation.json';
...
const SurahZalzalahTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة الزلزلة</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Zalzalah" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahZalzalah99Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahZalzalahTranslation;
