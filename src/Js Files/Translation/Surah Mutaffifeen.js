...
import Records from '../../json/83SurahMutaffifeen/SurahMutaffifeenTranslation.json';
...
const SurahMutaffifeenTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
      ...
      <div>
      <div className="tab">
      <NavLink to="/Surah Mutaffifeen" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahMutaffifeen83Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahMutaffifeenTranslation;
