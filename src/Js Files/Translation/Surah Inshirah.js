...
import Records from '../../json/94SurahInshirah/SurahInshirahTranslation.json';
...
const SurahInshirahTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة الشرح</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Inshirah" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahInshirah94Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahInshirahTranslation;
