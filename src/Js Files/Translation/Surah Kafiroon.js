...
import Records from '../../json/109SurahKafiroon/SurahKafiroonTranslation.json';
...
const SurahKafiroonTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة الكافرون</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Kafiroon" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahKafiroon109Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahKafiroonTranslation;
