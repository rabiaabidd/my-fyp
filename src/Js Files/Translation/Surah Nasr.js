...
import Records from '../../json/110SurahNasr/SurahNasarTranslation.json';
...
const SurahNasarTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة النصر</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Nasr" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahNasr110Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahNasarTranslation;
