...
import Records from '../../json/95SurahTeen/SurahTeenTranslation.json';
...
const SurahTeenTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة التين</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Teen" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahTeen95Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahTeenTranslation;
