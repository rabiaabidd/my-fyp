...
import Records from '../../json/106SurahQuraish/SurahQuraishTranslation.json';
...
const SurahQuraishTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة قريش</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Quraish" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahQuraish106Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahQuraishTranslation;
