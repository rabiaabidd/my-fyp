...
import Records from '../../json/96SurahAlaq/SurahAlaqTranslation.json';
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
      ...
      <div>
      <div className="tab">
      <NavLink to="/Surah Alaq" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahAlaq96Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahAlaqTranslation;
