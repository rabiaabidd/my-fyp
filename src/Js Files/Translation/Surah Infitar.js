...
import Records from '../../json/82SurahInfitar/SurahInfitarTranslation.json';
...
const SurahInfitarTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة الإنفطار</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Infitar" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahInfitar82Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
 ...
 {/*<div>
      <select value={selectedAudio} onChange={handleAudioChange}>
        ...
        <option value=" احمد رضا خان "> احمد رضا خان </option>
        <option value="Option 2">Audio Option 2</option>
        <option value="Option 3">Audio Option 3</option>
      </select>
      <p>You have selected: {selectedAudio}</p>
  </div>
  <NavLink to="/Video" className="tab-link" activeClassName="active-tab">
   Video
   </NavLink>
*/}
...
export default SurahInfitarTranslation;
