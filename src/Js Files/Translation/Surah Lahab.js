...
import Records from '../../json/111SurahLahab/SurahLahabTranslation.json';
...
const SurahLahabTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة لہب </center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Lahab" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahLahab111Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahLahabTranslation;
