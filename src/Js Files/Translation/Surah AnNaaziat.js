...
import Records from '../../json/79SurahAnNaaziat/SurahAnNaaziatTranslation.json';
...
const SurahAnNaaziatTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
      ...
      <div>
      <div className="tab">
      <NavLink to="/Surah AnNaaziat" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/AnNaaziat79Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahAnNaaziatTranslation;
