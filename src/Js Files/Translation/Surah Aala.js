...
import Records from '../../json/87SurahAala/SurahAalaTranslation.json';
...
const SurahAalaTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
      <div>
      <div className="tab">
      <NavLink to="/Surah Aala" className="tab-link" activeClassName="active-tab">
Word-By-Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahAala87Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahAalaTranslation;
