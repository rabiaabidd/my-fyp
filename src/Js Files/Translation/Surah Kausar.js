...
import Records from '../../json/108SurahKausar/SurahKausarTranslation.json';
...
const SurahKausarTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
        <center>سورة الكوثر</center>
        </h1>
      <div>
      <div className="tab">
      <NavLink to="/Surah Kausar" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahKausar108Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahKausarTranslation;
