...
import Records from '../../json/102SurahTakasur/SurahTakasurTranslation.json';
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
      ...
      <div>
      <div className="tab">
      <NavLink to="/Surah Takasur" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahTakasur102Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahTakasurTranslation;
