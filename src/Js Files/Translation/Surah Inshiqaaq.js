...
import Records from '../../json/84SurahInshiqaaq/SurahInshiqaaqTranslation.json';
...
const SurahInshiqaaqTranslation = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
    <h1>
      ...
      <div>
      <div className="tab">
      <NavLink to="/Surah Inshiqaaq" className="tab-link" activeClassName="active-tab">
Word By Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahInshiqaaq84Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
...
export default SurahInshiqaaqTranslation;
