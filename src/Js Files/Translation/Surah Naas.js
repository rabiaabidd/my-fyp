...
const Surah114 = () => {
  ...
  const handleShare = (e, shareLink) => {
   ...
   <div className="main">
      <div>
      <div className="tab">
      <NavLink to="/Surah Naas" className="tab-link" activeClassName="active-tab">
Word-By-Word Translation & Grammar
  </NavLink>
  <NavLink to="/SurahNaas114Resources" className="tab-link" activeClassName="active-tab">
More Resources
  </NavLink>
