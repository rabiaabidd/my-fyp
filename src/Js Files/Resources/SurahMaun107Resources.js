...
import Record from '../../json/107SurahMaun/107MaunResources.json';


const SurahMaun107Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الماعون</h1>
...
export default SurahMaun107Resources;
