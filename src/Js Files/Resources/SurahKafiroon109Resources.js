...
import Record from '../../json/109SurahKafiroon/109KafiroonResources.json';


const SurahKafiroon109Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الكافرون</h1>
...
export default SurahKafiroon109Resources;
