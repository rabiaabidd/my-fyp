...
import Record from '../../json/96SurahAlaq/96AlaqResources.json';


const SurahAlaq96Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة العلق</h1>
...
export default SurahAlaq96Resources;
