...
import Record from '../../json/103SurahAsr/103AsrResources.json';


const SurahAsr103Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة العصر</h1>
...
export default SurahAsr103Resources;
