...
import Record from '../../json/89SurahFajr/89FajrResources.json';


const SurahFajr89Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الفجر</h1>
...
export default SurahFajr89Resources;
