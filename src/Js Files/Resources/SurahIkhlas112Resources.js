...
import Record from '../../json/112SurahIkhlas/112IkhlasResources.json';


const SurahIkhlas112Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الإخلاص</h1>
...
export default SurahIkhlas112Resources;
