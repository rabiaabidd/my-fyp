...
import Record from '../../json/86SurahTariq/86TariqResources.json';


const SurahTariq86Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الطارق</h1>
...
export default SurahTariq86Resources;
