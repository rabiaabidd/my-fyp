...
import Record from '../../json/82SurahInfitar/82InfitarResources.json';


const SurahInfitar82Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الإنفطار</h1>
...
export default SurahInfitar82Resources;
