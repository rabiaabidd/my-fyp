...
import Record from '../../json/78SurahNaba/78NabaResources.json';


const SurahNaba78Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة النبإ</h1>
...
export default SurahNaba78Resources;
