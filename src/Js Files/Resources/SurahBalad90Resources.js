...
import Record from '../../json/90SurahBalad/90BaladResources.json';


const SurahBalad90Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة البلد</h1>
...
export default SurahBalad90Resources;
