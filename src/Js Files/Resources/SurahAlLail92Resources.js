...
import Record from '../../json/92SurahAlLail/92AlLailResources.json';


const SurahAlLail92Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الليل</h1>
...
export default SurahAlLail92Resources;
