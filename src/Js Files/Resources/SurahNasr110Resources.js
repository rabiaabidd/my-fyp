...
import Record from '../../json/110SurahNasr/110NasrResources.json';


const SurahNasr110Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة النصر</h1>
...
export default SurahNasr110Resources;
