...
import Record from '../../json/97SurahQadr/97QadrResources.json';


const SurahQadr97Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة القدر</h1>
...
export default SurahQadr97Resources;
