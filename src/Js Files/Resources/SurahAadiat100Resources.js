...
import Record from '../../json/100SurahAadiat/100AadiatResources.json';


const SurahAadiat100Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة العاديات</h1>
...
export default SurahAadiat100Resources ;
