...
import Record from '../../json/80SurahAbasa/80AbasaResources.json';


const SurahAbasa80Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة عبس</h1>
...
export default SurahAbasa80Resources;
