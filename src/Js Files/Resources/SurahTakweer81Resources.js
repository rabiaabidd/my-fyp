...
import Record from '../../json/81SurahTakweer/81TakweerResources.json';


const SurahTakweer81Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة التكوير</h1>
...
export default SurahTakweer81Resources;
