...
import Record from '../../json/105SurahFil/105FilResources.json';


const SurahFil105Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الفيل</h1>
...
export default SurahFil105Resources;
