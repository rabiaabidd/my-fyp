...
import Record from '../../json/88SurahGhashia/88GhashiaResources.json';


const SurahGhashia88Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الغاشية</h1>
...
export default SurahGhashia88Resources;
