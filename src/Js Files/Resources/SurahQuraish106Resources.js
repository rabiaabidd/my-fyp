...
import Record from '../../json/106SurahQuraish/106QuraishResources.json';


const SurahQuraish106Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة قريش</h1>
...
export default SurahQuraish106Resources;
