...
import Record from '../../json/84SurahInshiqaaq/84InshiqaaqResources.json';


const SurahInshiqaaq84Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الإنشقاق</h1>
...
export default SurahInshiqaaq84Resources;
