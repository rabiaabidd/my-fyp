...
import Record from '../../json/91SurahShams/91SurahShamsResources.json';


const SurahShams91Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الشمس</h1>
...
export default SurahShams91Resources;
