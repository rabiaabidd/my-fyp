...
import Record from '../../json/87SurahAala/87AalaResources.json';


const SurahAala87Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الأعلى</h1>
...
export default SurahAala87Resources;
