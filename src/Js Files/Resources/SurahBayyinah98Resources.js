...
import Record from '../../json/98SurahBayyinah/98BayyinahResources.json';


const SurahBayyinah98Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة البينة</h1>
...
export default SurahBayyinah98Resources;
