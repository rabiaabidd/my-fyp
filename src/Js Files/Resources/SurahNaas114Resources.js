...
import Record from '../../json/114SurahNaas/SurahNaas114Links.json';


const SurahNaas114Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الناس</h1>
...
export default SurahNaas114Resources;
