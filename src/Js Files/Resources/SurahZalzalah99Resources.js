...
import Record from '../../json/99SurahZalzalah/99ZalzalahResources.json';


const SurahZalzalah99Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الزلزلة</h1>
...
export default SurahZalzalah99Resources;
