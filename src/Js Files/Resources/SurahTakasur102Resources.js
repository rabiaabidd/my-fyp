...
import Record from '../../json/102SurahTakasur/102TakasurResources.json';


const SurahTakasur102Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة التكاثر</h1>
...
export default SurahTakasur102Resources;
