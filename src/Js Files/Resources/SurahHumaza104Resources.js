...
import Record from '../../json/104SurahHumaza/104HumazaResources.json';


const SurahHumaza104Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الهمزة</h1>
...
export default SurahHumaza104Resources;
