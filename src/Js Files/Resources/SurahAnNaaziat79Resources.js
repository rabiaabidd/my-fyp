...
import Record from '../../json/79SurahAnNaaziat/79SurahAnNaaziatResources.json';


const SurahAnNaaziat79Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة النازعات</h1>
...
export default SurahAnNaaziat79Resources;
