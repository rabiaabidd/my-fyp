...
import Record from '../../json/94SurahInshirah/94InshirahResources.json';


const SurahInshirah94Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title"> سورة الشرح</h1>
...
export default SurahInshirah94Resources;
