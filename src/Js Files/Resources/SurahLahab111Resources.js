...
import Record from '../../json/111SurahLahab/111LahabResources.json';


const SurahLahab111Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة لہب</h1>
...
export default SurahLahab111Resources;
