...
import Record from '../../json/113SurahFalak/113FalakResources.json';


const SurahFalak113Resources = () => {
  return (
    <div className="surah-container">

      <h1 className="surah-title">سورة الفلق</h1>
...
export default SurahFalak113Resources;
